...
static void main_window_load(Window *window) {
  ...
  #if defined(PBL_ROUND)
    s_battery_layer = text_layer_create(GRect(0,130, 180, 30));
  #else 
    //s_battery_layer = text_layer_create(GRect(0,130, 144, 30));
    s_battery_layer = text_layer_create(GRect(0,130, 175, 30));
  #endif
